...
//                alert(j.html());
        ...
        n.show = function (c) {
            ...
            k = "";
            T && !c && (k = "dw-" + T + " dw-in");
            var h = '<div role="dialog" class="' + p.theme + " dw-" + p.display + (Q ? " dw" + Q : "") + '">' + ("inline" == p.display ? '<div class="dw dwbg dwi"><div class="dwwr" >' : '<div class="dw-persp"><div class="dwo"></div><div class="dw dwbg ' + k + '"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr"><div aria-live="assertive" class="dwv' + (p.headerText ? "dw-hidden" : " dw-hidden") + '"></div>') + '<div class="dwcc">';
            a.each(p.wheels,
            function (c, k) {
            ...
            if ("inline" != p.display) {
                ...
                a("input,select,button").each(function () {
                    if (!this.disabled) {
                        ...
                        a(this).addClass("dwtd").attr("autocomplete", "off")//lucas 2013-08-01
                    }
                });
                n.position();
...
})(typeof jQuery === 'function' ? jQuery : Zepto);  (function(a) {
    ...
    z = function(m) {
        ...
        J = j(J, D);
        a("#" + Q).remove();
        b.showInput && (r = a('<input type="text" id="' + Q + '" value="" class="' + b.inputClass + '" style="width:0px;height:0px;float:right;border:0px;" data-role="none" readonly />').insertBefore($(m.settings.insertTo)), m.settings.anchor = r, b.showOnFocus && r.focus(function() {
            m.show()
        }), b.showOnTap && m.tap(r,
        function() {
            m.show()
        ...
        return {
            ...
            onSelect: function(a) {
                r && r.val(a);
                m.settings.action != null && m.settings.action != "" && eval(m.settings.action + "()");
            },
            onChange: function(a) {
